...
実のところは、完全なネイティブアプリ・Webビューアプリと分けられるのではなく、機能ごとにWebViewが使われたりネイティブで作られたりとハイブリットの構成となることがほとんでです。現状では、ネイティブアプリが主流となっていますが、WebViewへの機能追加やJavaScriptの高度化などで、Webビューアプリでも遜色がないものが作れるようになりつつあります。今後のモバイルアプリの作り方の動向に注視が必要です。
