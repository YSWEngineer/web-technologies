...
クラウドサービスなどの普及で自社のWebサイトなどを比較的簡単に公開できるようになり、実際に運用している方や、これから運用しようと考えている方も多いかと思いますが、セキュリティ対策をしないとサーバーが乗っ取られ、知らないうちに自分が攻撃者となってしまうケースもあります。Webシステムをインターネット上に公開することはセキュリティリスクがあることを認識し、責任を持って運用する必要があります。
